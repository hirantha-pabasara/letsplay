                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="card-body">
                                                        ...
                                                        <span class="fw-bold text-black fs-5"><?php echo $product_data["price"];?>.00</span>
                                                        <br>
                                                ...
                                                <div class="col-md-12 mt-3 mb-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6 col-md-6 text-end">
                                                            <span class="fw-bold fs-5 text-black-50"><?php echo ($product_data["price"] * $cart_data["qty"]) +$ship;?>.00</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
